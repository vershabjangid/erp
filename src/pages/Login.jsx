...
export function Login() {
  ...
  let [loginformchange, setloginformchange] = useState("Login");
              ...
              >
                <Form className='d-flex justify-content-center'>
                  <div className='login_input_fields d-flex flex-column '>
                    ...
                    <p className='mb-5 mt-1 text-white fw-bold text-center' onClick={() => setloginformchange("Employee")}>Login As Employee</p>
                  </div>
                ...
                >
                  <Form className='d-flex justify-content-center'>
                    <div className='login_input_fields d-flex flex-column '>
                      ...
                      <button type="submit" className='py-2 rounded-5 bg-white border-0 mt-3  fw-bolder fs-5'>Login</button>
                      <p className='mb-5 mt-1 text-white fw-bold text-center' onClick={()=>setloginformchange("Login")}>Login As Admin</p>
                    </div>
